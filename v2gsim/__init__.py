...
import v2gsim.battery_degradation.Fixeddegradation
...
__all__ = ['v2gsim.itinerary', 'v2gsim.core', 'v2gsim.model', 'v2gsim.post_simulation.netload_optimization',
           ...
           'v2gsim.post_simulation.result', 'v2gsim.battery_degradation.Fixedexample','v2gsim.battery_degradation.Fixeddegradation']
